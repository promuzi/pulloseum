...
| 2 | 양육/열매 시스템 ⭐ | 🟢 **코어 구현 완료**(루프 작동) | 보급박스·탐사결과를 공통 RewardReveal 시각으로 통일(Task 7 잔여) | [nurture spec](superpowers/specs/2026-06-24-nurture-fruit-system-design.md) · [plan](superpowers/plans/2026-06-24-nurture-fruit-system.md) |
