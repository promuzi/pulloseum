...
| # | 방향 | 상태 | 다음 한 걸음 | 관련 문서 |
|---|------|------|-------------|----------|
| 1 | 식물 종류 확장 | 🟡 외형 시스템 + **base 35 고유스킬 완료**, 변이 진행 중 | 버섯 성체/완숙 14 + 변이 개체 140 채우기(`ind.<key>.g/.m/.e`) | [species](species-system-guide.md) · [impl plan](superpowers/plans/2026-06-25-species-individual-concepts-implementation.md) |
