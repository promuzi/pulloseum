...
| 9 | 구글 플레이 출시 | 🟢 **출시 스프린트 진행(2026-09-10~)** — UX P0-A 첫 세션 재배선 완료(잠금·배너 숨김, 심기 1탭, 강화 모달 자동 오픈 폐지, 첫 전투 CTA, 3v3·미션 2승 해금) · 화면 캡처 도구 `tools/shots/` | P0-B 가독성(폰트 동봉·12px·48px) → P0-C 전투 피드백 → P0-D 정리 → 로컬 번들·서명 → 비공개 테스트(12명×14일) | [ux-audit](superpowers/specs/2026-09-10-ux-audit-and-design.md) · [android](android-capacitor-wrapper.md) |
