...
| **17** | **전투 코어 3v3 재설계 — 팀·심리전·손패·두 리그** ⭐재미 재설계 1부 | ✅ **1차 구현 완료(2026-07-02)** — 팀3 출전·교체=턴 소모 심리전·덱8/손패4 CR 사이클·공유 에너지 커브(시작2·+1/턴·최대8)·봇 아키타입 성향 tell+큰기술 ⚠️예고·**두 리그**(1v1=개체 랭크 / 3v3=재배사 랭크 `team_rankPoints`)·미션 `enemies[]` 팀전. Task 1~10 전부 커밋·E2E 검증 | 밸런스 체감 튜닝 · 팀 편성 홈 UI · **2부 메타루프 브레인**(양육↔팀) · 3부 UI 전면 | [spec](superpowers/specs/2026-07-02-battle-core-3v3-redesign-design.md) · [plan](superpowers/plans/2026-07-02-battle-core-3v3-redesign.md) |
