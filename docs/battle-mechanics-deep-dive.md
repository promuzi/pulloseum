...
> 스탯표·데미지 공식 요약·티어표는 자매 문서 [`balance-sheet.md`](balance-sheet.md)(밸런스 시트)와 겹치므로, 여기서는 **진행 순서 · 봇 구성 · 예약된 패시브**에 집중한다.
...
> 스킬 스펙 표는 [`balance-sheet.md` §5](balance-sheet.md) 참조.
